...
class VideoModel extends Model
{
    ...
    {
        $sql = "SELECT videos.id, url, title, description, duration, views, thumbnail_url, videos.created_at, videos.update_at, username, avatar_url FROM videos INNER JOIN users ON videos.author_id = users.id  AND category_id = :category_id ORDER BY created_at ASC LIMIT $offset, $limit";
