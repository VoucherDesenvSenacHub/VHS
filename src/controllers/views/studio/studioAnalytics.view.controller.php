...
class StudioAnalyticsViewController extends Controller {
    ...
    public function index() {
        ...
        $last_comments = $this->commentModel->getStudioComments(0, 7, $user_id, '', 'DESC');
        $last_comments = array_slice($last_comments, 0, 7);
        $this->view("studio/index",['count_followers' => $count_followers, 'all_views' => $views[0]['views'], 'average_views' => $views[0]['average'], 'average_avaliations' => $videos_avaliations_avg[0]['average'], 'last_comments' => $last_comments]);   
    }
}