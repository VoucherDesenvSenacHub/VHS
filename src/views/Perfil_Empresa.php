...
<body class="w-full min-h-screen bg-gradient-to-b from-[#20002c] to-[#000000] bg-no-repeat bg-cover bg-center">
    <div class="p-4 sm:p-6 md:p-8 mt-25 sm:mt-50 sm:ml-50 xs:p-4">
        ...
        <div class="mt-16 xs:mt-20 sm:mt-0">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                ...
                <button class="w-[150px] xs:w-[150px] h-[35px] xs:h-[40px] mt-4 sm:-mt-6 bg-none text-white px-3 xs:px-4 py-1 xs:py-2 rounded-[10px] border border-violet-500 ml-2 xs:ml-4 text-sm xs:text-base">Seguir</button>
            </div>
        </div>
        <div>
        <p class="text-white">Descriçao</p>
        <div>
