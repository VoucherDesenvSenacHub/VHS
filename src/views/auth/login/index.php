      ...
      <div class="relative mx-20 w-1/2 flex items-center justify-center shadow-[-10px_0_30px_10px_rgba(255, 255, 255, 1)]">
        <div class="flex flex-col gap-4">
            <div class="flex items-center flex-col gap-2">
                ...
                <p class="text-[33px] font-pop font-semibold title-size text-[#fff]">Entrar na sua conta</p>
            ...
            <div class="flex flex-col gap-4 w-96">
                ...
                <div class="flex gap-[2px] items-center justify-center">
                  ...
                  <a class="font-pop paragraph-size text-[#660BAD] underline" href="#">Cadastrar</a>
                </div>
            </div>
        </div>
    </div>
