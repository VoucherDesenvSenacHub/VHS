<?php
    ...
    function InputComponent(
        ...
        // $label = $label ? "<label class='$label_size font-medium text-white mb-2'>$label</label>" : "";
        ...
        // $description = $description ? "<p class='$description_size text-gray-200 mb-3'>$description</p>" : "";
