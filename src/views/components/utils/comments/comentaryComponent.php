...
function Comment(string $name, string $text, string $created_at = null, string $userImg = null)
{
    ...
    $created_at = $created_at ? "<p class='text-xstext-gray-300 font-semibold ml-1'>" . htmlspecialchars($created_at, ENT_QUOTES, 'UTF-8') . "</p>" : "";
        ...
        <div class='comment-container w-full flex items-center gap-4 py-2 mt-4'>
            ...
            <div class='flex flex-col w-full'>
                ...
                <div class='flex flex-col text-sm font-medium text-gray-400 break-all whitespace-pre-line max-w-fit inline-block'>
                    <p  class='mt-2 comment-text overflow-hidden max-h-16 transition-all duration-300' >$text</p>
                    $readMoreButton
                </div>
            </div>
            ...
            <div class='w-5 h-5 ml-3 mt-2 cursor-pointer relative opcoes self-start'>
                ...
                top-0 right-full mr-4 absolute hidden menu'>
                    <ul class='w-full flex flex-col gap-3'>  
                        <li class='hover:bg-gray-700 text-white font-semibold flex w-16 h-5 text-xs gap-2 items-center ml-1' onclick=''>
