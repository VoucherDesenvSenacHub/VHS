...
function BarComponent() {
    return <<<HTML
        <button class='barrinha min-w-10 min-h-10 rounded-full hover:bg-white/10 active:bg-transparent flex items-center justify-center transition-all duration-200'>
