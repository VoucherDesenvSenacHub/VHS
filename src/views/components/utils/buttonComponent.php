...
use function Src\Application\Utils\Purify\purifyProperty;
    ...
    **/
    function ButtonComponent(string $text, string $variant, string | null $icon = null, float $width = 23.875, float $height = 3.125, $id = null, string | null $link = null, bool $isActive = false, null $onclick = null, string $className = "", array $attributes = [], string $type = "") {
