        ...
        return <<<HTML
            <div id='user-menu' class='hidden fixed w-full sm:w-72 mx-auto flex flex-col h-auto sm:h-max bg-[#1b1b1b] rounded-tr-3xl rounded-tl-3xl sm:rounded-3xl overflow-hidden shadow-md shadow-black/50 transition-all duration-300 sm:duration-200 ease-out translate-y-full sm:translate-y-0 scale-95 bottom-0 sm:top-20 sm:right-5 z-20'>
                ...
                <div class='flex flex-col border-b border-gray300'>
                    <a href='/VHS/src/views/users/manageProfile/index.php' id='button-myaccount' class='flex p-1 sm:p-2 items-center gap-2 hover:bg-white/5 focus:bg-white/10 transition-all duration-200 cursor-pointer'>
                    ...
                    <a href='/VHS/src/views/adm/Analytics/AnalyticsPage.php' id='button-dashboard' class='flex p-1 sm:p-2 items-center gap-2 hover:bg-white/5 focus:bg-white/10 transition-all duration-200 cursor-pointer'>
                        <div class='flex-shrink-0 w-12 h-12 3xl:w-14 3xl:h-14 p-3 flex justify-center items-center'>
                ...
                <a href='/VHS/src/views/auth/login/index.php' id='button-logout' class='flex p-1 sm:p-2 items-center gap-2 hover:bg-white/5 focus:bg-white/10 transition-all duration-200 cursor-pointer'>
                    <div class='flex-shrink-0 w-12 h-12 3xl:w-14 3xl:h-14 p-3 flex justify-center items-center'>
