            ...
            <aside class='sidebar hidden opacity-0 sm:opacity-100 -translate-x-full sm:translate-x-0 px-4 sm:flex sticky flex-col items-center w-[4.5rem] sm:w-auto h-full top-[4.5rem] left-0 select-none transition-all duration-300 z-10'>
                ...
                <div class='flex flex-col gap-6'>
                    <div class='flex flex-col gap-6 justify-center'>
                        ...
                        <button class='option flex flex-row gap-4 items-center group hover:bg-white/5 rounded-xl'>
                            <div class='bg-white/5 group-hover:bg-white/0 p-[0.5rem] rounded-xl transition-colors duration-300 ease-in-out'>
                                <img src='$iconHome' class='w-[20px] sm:w-[25px] 3xl:w-[30px] min-w-[20px] max-w-[30px]'>
                            </div>
                            
                            <h2 class='menu-titles hidden text-white/75 group-hover:text-white/100 text-paragraph transition-opacity duration-300 ease-in-out'>
                                $titleHome
                            </h2>
                        </button>

                        
                        <button class='option flex flex-row gap-4 items-center'>
