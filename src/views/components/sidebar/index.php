<?php
    ...
    */
    ...
    function CreateSidebar(
        ...
        return "
            <aside class='sidebar hidden opacity-0 sm:opacity-100 -translate-x-full sm:translate-x-0 px-4 sm:flex sticky flex-col items-center w-[4.5rem] sm:w-auto h-full top-[80px] left-0 select-none transition-all duration-300 z-10'>
            
                <div class='flex flex-col gap-6'>
                    <div class='flex flex-col gap-6 justify-center'>
                        <h2 class='hidden menu-titles text-secondary/50 text-caption'>$titleMenu</h2>

                        <a href='' class='option flex flex-row gap-4 items-center cursor-pointer'>
                        ...
                        <a href='' class='option flex flex-row gap-4 items-center cursor-pointer'>
                            ...
                            <h2 class='menu-titles hidden text-white/75 text-paragraph transition-opacity duration-300 ease-in-out'>
                                $titleFast
                            </h2>
                        </a>
