...
function RemoveFastComponent(string $title, string $description, string $id)
{
    ...
    return <<<HTML
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="border border-white rounded-xl shadow-lg p-6 w-[400px] text-white bg-[#1B1B1B]">
                ...
                <form action="/VHS/api/v1/fast/delete" method="post" class="flex justify-end gap-4">
