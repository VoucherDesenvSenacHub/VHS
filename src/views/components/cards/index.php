...
<?php
    ...
    class Cards {
        ...
        private function Video(): string {
            return "
                <a href='{$this->url}' class='card flex flex-col cursor-pointer relative max-w-[350px] h-[340px] bg-gray600 rounded-3xl overflow-hidden shadow-lg transition-all duration-300'>
        ...
        private function Event() {
            return "
                <a href='{$this->url}' class='card flex flex-col cursor-pointer max-w-[350px] h-[340px]  bg-[#1B1B1B] rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300'>
                    <div class='relative w-full h-[50%]'>
                        <img src='{$this->thumbnail_url}' class='w-full h-full object-cover'>
